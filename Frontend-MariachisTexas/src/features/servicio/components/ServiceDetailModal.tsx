      ...
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90vh] animate-fade-in-up overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-slate-50/30">
            ...
            <div className="flex flex-col items-center mb-8">
                ...
                <h2 className="text-2xl font-serif font-bold text-slate-800">{service.name}</h2>
                <div className="flex gap-2 mt-2">
                    <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase ${service.isActive ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'}`}>
            ...
            <div className="grid grid-cols-1 gap-4 mb-6">
                <div className="flex items-start gap-3 p-3 bg-white rounded-xl border border-slate-100 shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-bold text-slate-700 font-mono">${service.price.toLocaleString()}</p>
                    </div>
                </div>
            </div>
