          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative group cursor-pointer">
                <div className="w-28 h-28 rounded-full bg-dark-800 border-2 border-dashed border-gray-700 flex items-center justify-center group-hover:border-secondary-500 transition-colors">
              ...
              <div>
                ...
                {emailFromUrl && (
                  <p className="text-[10px] text-emerald-500/70 mt-1 ml-1">
                    Este correo está vinculado a tu reserva — no lo cambies.
                  </p>
                )}
              </div>
            ...
            <div className="pt-4">
              <button type="submit" disabled={isLoading}
                ...
                {isLoading ? <><Loader2 size={18} className="animate-spin" /> Registrando...</> : 'Completar Registro'}
              </button>
            </div>
          </form>
