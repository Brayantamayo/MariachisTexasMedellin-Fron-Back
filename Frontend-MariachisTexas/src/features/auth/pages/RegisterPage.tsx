...
export const RegisterPage: React.FC<Props> = ({ onNavigate }) => {
  ...
  // ✅ Mapeo de valores del select al enum de Prisma
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ Mostrar mensaje del backend si existe, si no un mensaje genérico
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input type="number" name="numeroDocumento" value={formData.numeroDocumento} onChange={handleChange}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input type="text" name="barrio" value={formData.barrio} onChange={handleChange}
                    className="w-full pl-11 pr-4 py-3 bg-dark-800/50 border border-white/10 rounded-xl text-white placeholder-gray-600 focus:ring-2 focus:ring-white/20 outline-none transition-all text-sm font-medium"
                    placeholder="Tu barrio" required />
                </div>
              </div>
