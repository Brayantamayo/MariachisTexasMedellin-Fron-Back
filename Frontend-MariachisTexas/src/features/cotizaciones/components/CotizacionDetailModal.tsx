...
import { X, Calendar, Clock, MapPin, User, Music, DollarSign, Mail, Phone, Tag, Check, Package } from 'lucide-react';
      ...
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar bg-white">
          <div className="flex flex-col md:flex-row h-full">
            ...
            {/* Columna Derecha */}
            <div className="w-full md:w-1/2 flex flex-col bg-slate-50 h-[400px] md:h-auto">

              {/* Servicios — usando nombre y precio en español */}
                      ...
                      return (
                        <div key={item.serviceId} className="flex justify-between items-center p-3 bg-slate-50 rounded-xl border border-slate-200">
                          <div>
                            ...
                            <p className="text-[10px] text-slate-400">${Number(service.precio).toLocaleString()} x {item.quantity}</p>
                          </div>
