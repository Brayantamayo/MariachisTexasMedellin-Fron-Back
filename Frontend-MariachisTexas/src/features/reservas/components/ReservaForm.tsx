...
export const ReservaForm: React.FC<Props> = ({ 
  ...
  React.useEffect(() => {
      const timeField = formData.startTime || formData.eventTime;
      if (timeField) {
          const newEndTime = calculateEndTime(timeField, extraHoursQuantity);
  ...
  }, [formData.startTime, formData.eventTime, extraHoursQuantity, onChange, formData.endTime]);
                            ...
                            <div className="flex-1">
                                ...
                                <div className="relative">
                                    <select 
                                        ...
                                        onChange={(e) => {
                                            onChange(e);
                                            // También actualizamos eventTime por compatibilidad
                                    ...
                                    >
                                        ...
                                        {(formData.startTime || formData.eventTime) && !availableHours.includes(formData.startTime || formData.eventTime) && (
                                            <option key={`start-current-${formData.startTime || formData.eventTime}`} value={formData.startTime || formData.eventTime}>{formData.startTime || formData.eventTime} (Actual)</option>
                                        )}
                                    </select>
