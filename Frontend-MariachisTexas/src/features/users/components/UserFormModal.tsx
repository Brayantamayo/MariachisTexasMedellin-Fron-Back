...
import { X, Save, User as UserIcon, Camera, Lock, Music, MapPin, Phone, Mail, FileText, Calendar, Hash, AlertCircle } from 'lucide-react';
...
const validate = (data: any, isCreating: boolean): UserErrors => {
  ...
  if (data.role === UserRole.EMPLEADO && !data.mainInstrument?.trim())
                                    errors.mainInstrument = 'El instrumento principal es requerido';
  return errors;
};
      ...
      <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex flex-col max-h-[90vh] animate-fade-in-up overflow-hidden">
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-slate-50/30">
          <form id="user-form" onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
                <div className="md:col-span-2">
                  ...
                  <select name="role" value={formData.role} onChange={handleChange} disabled={isViewOnly}
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" name="email" disabled={isViewOnly} value={formData.email} onChange={handleChange}
                      className={`input-form pl-10 ${errClass(!!errors.email)}`} placeholder="correo@ejemplo.com" />
                  </div>
            ...
            {/* 4. Perfil Musical (solo EMPLEADO) */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                  <div>
                    ...
                    <input type="text" name="mainInstrument" disabled={isViewOnly} value={formData.mainInstrument} onChange={handleChange}
                      className={`input-form border-primary-200 ${errClass(!!errors.mainInstrument)}`} placeholder="Ej: Trompeta" />
                  ...
                  <div className="md:col-span-2">
                    ...
                    <input type="text" name="otherInstruments" disabled={isViewOnly} value={formData.otherInstruments} onChange={handleChange}
                      className="input-form border-primary-200" placeholder="Ej: Voz, Guitarra (separar por comas)" />
                  </div>
                  <div>
